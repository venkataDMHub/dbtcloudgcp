...
{% set large_deposits_followed_by_transfer_threshold_business={
    'NGN': 747.55,
    'KES': 649.53,
    'RWF': 15.44,
    'TZS': 91.91,
...
with inbound_transfers as (
    select 
        ...
        hlo_updated_at as received_time,
...
where 
    {% for currency, deposit_limit in large_deposits_followed_by_transfer_threshold_business.items() %}
