...
with
    ...
    ninepsb_deposits as (
        ...
        select
            ...
            transfers.origin_amount * {{ ninepsb_fee_pct }} as percentage_fee,
            iff(percentage_fee >= 100, 100, percentage_fee) as fee,
        ...
        where
            ...
            and details.external_provider = 'NINEPSB'
