...
with
    ...
    wiztransact_withdrawals as (
        ...
        select
            ...
            destination_amount * {{ wiztransact_fee_pct }} as fee,
        ...
        where
            ...
            and details.external_provider = 'WIZTRANSACT'
