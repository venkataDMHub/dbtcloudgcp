{{ config(materialized='table', schema='intermediate', unique_key='fee_calculation_id') }}
...
with
    ...
    non_fx as (
        ...
        select
            ...
            cast(0 as float) as operating_expenses_in_usd,
        ...
        where
            revenues.revenue_stream in ('NON_FOREX_FEES')
