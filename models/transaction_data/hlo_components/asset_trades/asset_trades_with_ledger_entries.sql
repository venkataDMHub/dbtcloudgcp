...
select
    ...
    case
        ...
        else concat(hlo_table, '_', hlo_position, '_', hlo_status)
...
from
    {{ ref('asset_trades_with_all_transfer_ids') }} as asset_trades
inner join
    {{ ref('ledger_entries') }} as ledger_entries on
        ledger_entries.journal_id = asset_trades.hlo_journal_id
where
